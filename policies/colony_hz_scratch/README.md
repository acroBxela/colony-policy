# Colony Can-Am policy: colony_hz_scratch

Self-contained CPU JAX/StableHLO policy and closed-loop model prediction.
Selected checkpoint: `step_000170000384`. Trained from scratch, not fine-tuned.
...
- Model: `can_am_x3_r322_exptanh_planar____`, checkpoint 5800, model source
  commit `35483d0`. Frozen identified dynamics; no actuator lag or parameter noise.
- 240,123,904 training frames in approximately 90 seconds on RTX 5080;
  selected actor at 170,000,384 frames.
...
- Independent 128-seed evaluation: 128/128 completed; mean lap 20.6878 s,
  RMS e 0.1817 m, peak |e| 0.8245 m, peak |ay| 3.4404 m/s².
...
Nominal result: 1060 samples, 21.1647 s lap, peak |e| 0.2695 m.
Surface reconstruction maximum x/y error: 0.0000064 m.
