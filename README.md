...
| --- | --- | --- | --- |
| [colony_fiala](policies/colony_fiala/README.md) — latest | −400 to 1000 | Squared excess above \|ay\| = 7 m/s², weight 30 | 128/128 completed; 18.48 s mean lap; RMS e 0.152 m |
...
`colony_fiala` uses `can_am_x3_r322_fiala_planar_vnew2`, checkpoint 1600,
...
weight 12. Its selected checkpoint is `step_000210108416`. Earlier versions
...
cd colony-policy/policies/colony_fiala
...
```python
from policies.colony_fiala.load_policy import load_policy
from policies.colony_fiala.policy_unroll import policy_unroll
